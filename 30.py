...
x = input (f" podaj imie nr 1: ")
lista.append(x)
x = input (f" podaj imie nr 2: ")
lista.append(x)
x = input (f" podaj imie nr 3: ")
lista.append(x)
x = input (f" podaj imie nr 4: ")
lista.append(x)
x = input (f" podaj imie nr 5: ")
lista.append(x)
